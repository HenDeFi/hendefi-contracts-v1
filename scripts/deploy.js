...
const MARKET_RESERVES = '100000';   // 10000 TOKEN in market reserves

const BASE_ADDRESS = '0x039e2fB66102314Ce7b64Ce5Ce3E5183bc94aD38';  // BASE Token Address (eg scUSD)
const MULTISIG = '0x7F9634C927890F8675b1CA7f35C485EAb772A113';      // Multisig Address
...
async function getContracts() {
     ...
     OTOKENFactory = await ethers.getContractAt("contracts/OTOKENFactory.sol:OTOKENFactory", "0x397aE914a576Bb933d0e6F662200c45e053d3425");
     VTOKENFactory = await ethers.getContractAt("contracts/VTOKENFactory.sol:VTOKENFactory", "0x85bbdfee9D3240a8e3b44BD267504149b9601062");
     feesFactory = await ethers.getContractAt("contracts/TOKENFeesFactory.sol:TOKENFeesFactory", "0x3a2Cbc818890807d97b1264ED47903Ed72521844");
     rewarderFactory = await ethers.getContractAt("contracts/VTOKENRewarderFactory.sol:VTOKENRewarderFactory", "0x2c19E444c90220ca000452C797bc2cc3E8403697");

     TOKEN = await ethers.getContractAt("contracts/TOKEN.sol:TOKEN", "0x41408E1510AC6f651FD6D8a142EC1B24bdAF1b5B");
     ...
     governor = await ethers.getContractAt("contracts/TOKENGovernor.sol:TOKENGovernor", "0xd28bBB6f11a722af3CDF909E19525d212eA0f74e");

     gaugeFactory = await ethers.getContractAt("contracts/GaugeFactory.sol:GaugeFactory", "0xeA1DB4c7a507A736A0388fF0bFeD24b4bA424429");
     bribeFactory = await ethers.getContractAt("contracts/BribeFactory.sol:BribeFactory", "0xb557Fa65aF0f482E34799eFA76176B269Cd88c40");
...
async function deployTOKEN() {
    ...
    console.log("OTOKENFactory.address: ", OTOKENFactory.address);
    console.log("VTOKENFactory.address: ", VTOKENFactory.address);
    console.log("rewarderFactory.address: ", rewarderFactory.address);
    console.log("feesFactory.address: ", feesFactory.address);
    console.log("convert(MARKET_RESERVES, 18): ", convert(MARKET_RESERVES, 18));
    const TOKENContract = await TOKENArtifact.deploy(BASE_ADDRESS, convert(MARKET_RESERVES, 18), OTOKENFactory.address, VTOKENFactory.address, rewarderFactory.address, feesFactory.address);
